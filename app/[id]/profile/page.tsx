...
export default function ProfilePage() {
    ...
    const [newAddress, setNewAddress] = useState({
        fullName: "", phone: "", country: "", city: "", zipCode: "", detail: ""
    });
    ...
    const handleSaveProfile = () => {
        const updatedData = { fullName, password, gender, email, username: mockUser.username };
    ...
    const handleSaveAddress = () => {
        if (!newAddress.fullName || !newAddress.phone || !newAddress.detail) return alert("กรุณากรอกข้อมูลให้ครบถ้วน");

        let updatedList;
        if (editingIndex !== null) {
            updatedList = addressList.map((item, idx) =>
                idx === editingIndex ? { ...newAddress, isDefault: item.isDefault } : item
            );
        } else {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900 relative">
            ...
            <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <AddressSection
                        ...
                        onOpenAddModal={() => {
                            setEditingIndex(null);
                            setNewAddress({ fullName: "", phone: "", country: "", city: "", zipCode: "", detail: "" });
                            setIsAddrModalOpen(true);
                        }}
            ...
            <PasswordModal
                ...
                oldPass={oldPassword} setOldPass={setOldPassword}
                newPass={newPassword} setNewPass={setNewPassword}
            ...
            <AddressModal
                ...
                data={newAddress}
                onChange={(e) => { const { name, value } = e.target; setNewAddress(prev => ({ ...prev, [name]: value })); }}
